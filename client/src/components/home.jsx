...
function Home() {
  return (
    <div className="page-bg relative overflow-hidden">
      ...
      <div className="glow-orb w-96 h-96 bg-violet-600 top-10 -left-20" />
      <div className="glow-orb w-80 h-80 bg-cyan-500 top-40 right-0" />
      <div className="glow-orb w-64 h-64 bg-pink-500 bottom-60 left-1/3" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-20">
        ...
        <section className="flex flex-col md:flex-row items-center gap-14 mb-28">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-slate-200 leading-relaxed max-w-xl mb-8">
            ...
            <div className="flex flex-wrap gap-4 justify-center md:justify-start">
              ...
              <a
                ...
                className="px-6 py-3 rounded-xl border border-violet-500/40 text-violet-300 font-semibold hover:bg-violet-500/10 hover:border-violet-400 transition-all duration-300 hover:-translate-y-0.5"
              >
                Resume ↗
              </a>
            </div>
        ...
        <section className="mb-28">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-300">Technologies I work with across the full stack and AI/ML</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
            {skills.map((skill, i) => {
              ...
              return (
                <div
                  key={i}
                  className={`bg-slate-900/60 border ${c.border} rounded-2xl p-6 hover:bg-slate-900/80 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl`}
                >
        ...
        <section className="mb-28">
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-2xl p-8 hover:border-violet-500/20 transition-colors duration-300">
        ...
        <section className="mb-20">
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-2xl p-8 hover:border-emerald-500/20 transition-colors duration-300">
